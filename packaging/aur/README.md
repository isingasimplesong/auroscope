...
This recipe pins immutable AURoscope commit `c4ca4517f9c8b32f5ab91ecb6df7e87c10f9565e`, including the compact interactive review and packaging-focused Codex audit contract from issue #31. Update `_commit`, `pkgver`, and `sha256sums` together when advancing the package.
