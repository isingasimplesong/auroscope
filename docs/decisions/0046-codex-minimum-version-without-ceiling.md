...
This records design acceptance only. Implementation, real qualification of Codex 0.153.4, and a new packaged release require a separate `MODE: EXECUTION` issue. The current implementation still admits only 0.150.1 and 0.151.0. ADR-0015's mandatory Codex audit and human-authority boundaries remain unchanged.
